...
${OBJECTDIR}/src/bytearray.o: src/bytearray.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/bytearray.o src/bytearray.cpp

${OBJECTDIR}/src/exceptionbase.o: src/exceptionbase.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exceptionbase.o src/exceptionbase.cpp

${OBJECTDIR}/src/logger.o: src/logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/logger.o src/logger.cpp

${OBJECTDIR}/src/stringmanip.o: src/stringmanip.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/stringmanip.o src/stringmanip.cpp

${OBJECTDIR}/src/stringmanipexception.o: src/stringmanipexception.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/stringmanipexception.o src/stringmanipexception.cpp

${OBJECTDIR}/src/stringvalid.o: src/stringvalid.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/stringvalid.o src/stringvalid.cpp
