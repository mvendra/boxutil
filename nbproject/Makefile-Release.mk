...
${OBJECTDIR}/src/bytearray.o: src/bytearray.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/bytearray.o src/bytearray.cpp

${OBJECTDIR}/src/exceptionbase.o: src/exceptionbase.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/exceptionbase.o src/exceptionbase.cpp

${OBJECTDIR}/src/stringmanip.o: src/stringmanip.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/stringmanip.o src/stringmanip.cpp

${OBJECTDIR}/src/stringmanipexception.o: src/stringmanipexception.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/stringmanipexception.o src/stringmanipexception.cpp

${OBJECTDIR}/src/stringvalid.o: src/stringvalid.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/stringvalid.o src/stringvalid.cpp

${OBJECTDIR}/src/strveccont.o: src/strveccont.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/strveccont.o src/strveccont.cpp
